...
public class Test {
	...
	public static void runAsCompany() throws LoginEx, InterruptedException, DateProblem, SQLException, ExistEx {
		...
		Date date3 = new Date(System.currentTimeMillis()-(1000 * 24 * 6 * 60 * 60));
		Date date4 = new Date(System.currentTimeMillis()-(1000 * 24 * 5 * 60 * 60));
		...
		Coupon coupon10 = new Coupon(10, "bla bla", date3, date4, 5, couponType, "new", 112.3, "http:googleimage");
		...
		companyFacade.createCoupon(coupon10, comp);
